...
public class RaigadConfiguration implements IConfiguration {
    ...
    // Defaults
    private final String defaultClusterName = "es_samplecluster";
    ...
    private final DynamicStringProperty securityGroupName = DynamicPropertyFactory.getInstance().getStringProperty(CONFIG_SECURITY_GROUP_NAME, defaultClusterName);
    ...
    public String getAppName() {
        return config.get(CONFIG_CLUSTER_NAME, defaultClusterName);
    }
